...
export declare const applyChanges: <
  T extends Node<any, any> | Edge<any, any> | FlowElement<any, any, any, any> = Node<any, any>,
...
export declare const createAdditionChange: <
  ...
  C extends NodeAddChange<any> | EdgeAddChange<any> = T extends GraphNode<any, any> ? NodeAddChange<any> : EdgeAddChange<any>,
>(
  item: T,
) => C
export declare const createRemoveChange: (id: string) => NodeRemoveChange | EdgeRemoveChange
export declare const getSelectionChanges: (
